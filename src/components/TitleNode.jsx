...
function TitleNode({ data, id }) {
  ...
  return (
    <NodeWrapper id={id} data={data} maxPerSide={1}
      style={{ width: 250, height: 83.33, border: `2px solid ${data.strokeColor || '#747474'}`, borderRadius: 4.35, background: data.fillColor || 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      {editing ? (
